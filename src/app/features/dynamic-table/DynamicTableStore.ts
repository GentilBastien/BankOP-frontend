...
import {DynamicTableService} from "../../core/services/DynamicTableService";
...
export class DynamicTableStore {
  private yearDtosSubject: BehaviorSubject<TreePriceTableDto> = new BehaviorSubject<TreePriceTableDto>(
    {years: []}
  );
